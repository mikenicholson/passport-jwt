 ...
 *          allowEmpty: If true and no JWT found in the request, will succeed with empty (null) user instead of failing with "Not auth token" error.
...
JwtStrategy.prototype.authenticate = function(req, options) {
    ...
    if (!token) {
        return !this._allowEmpty ? self.fail(new Error("No auth token")) : self.success(null)
    }
