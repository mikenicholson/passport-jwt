...
var AUTH_HEADER = "authorization"
    ...
    , DEFAULT_TOKEN_COOKIE_NAME = 'jwt_session'
 ...
 *          tokenCookieName: Name of the cookie containing token. Default is 'jwt_session'.
...
function JwtStrategy(options, verify) {
    ...
    this._tokenCookieName = options.tokenCookieName || DEFAULT_TOKEN_COOKIE_NAME;
...
JwtStrategy.prototype.authenticate = function(req, options) {
    ...
    // If not in the body, look for a cookie
    if(!token && req.cookies) {
      token = req.cookies[self._tokenCookieName];
    }
