...
var auth_header_1 = require("./auth_header.cjs"); // Note: express http converts all headers
// to lower case.
      ...
      return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              if (!(_i < extractors_1.length)) return [3
              /*break*/
              , 4];
...
//# sourceMappingURL=extract_jwt.cjs.map
