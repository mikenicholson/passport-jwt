...
var jsonwebtoken_1 = require("../platforms/jsonwebtoken");
var jsonwebtoken_2 = tslib_1.__importDefault(require("jsonwebtoken"));
var JwtAutoStrategy = /** @class */ (function (_super) {
    ...
    function JwtAutoStrategy(extOptions, verify) {
        ...
        return _super.call(this, tslib_1.__assign({ jwtDriver: new JwtAutoStrategy.OverrideAutoDriver(jsonwebtoken_2.default, driverOptions) }, extOptions), verify) || this;
    }
