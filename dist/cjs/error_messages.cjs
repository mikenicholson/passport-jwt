...
(function (ErrorMessages) {
  ...
  ErrorMessages["NO_PROMISE_RETURNED"] = "JwtStrategy requires a promise from the SecretOrKeyProvider or the provider should use the callback, something else has been returned.";
  ErrorMessages["JOSE_CORE_INCOMPATIBLE"] = "JoseDriver has been given a core which is incompatible with 'jose' library.";
  ErrorMessages["JWT_CORE_INCOMPATIBLE"] = "JsonWebTokenDriver has been given a core which is incompatible with 'jsonwebtoken' library.";
  ErrorMessages["NEST_CORE_INCOMPATIBLE"] = "NestJsJwtDriver has been given a core which is incompatible with '@nestjs/jwt' library.";
  ErrorMessages["USER_TRUE_WITH_MESSAGE"] = "JwtStrategy validate callback did give both a truthy user object and a failure message, could not determine is user should be authenticated.";
...
(function (FailureMessages) {
  ...
  FailureMessages["USER_NOT_TRUTHY"] = "The provided user is not truthy";
