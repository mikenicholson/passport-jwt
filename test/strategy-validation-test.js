...
describe("Strategy", function () {
    describe("calling JWT validation function", function () {
        ...
        before(function (done) {
            ...
            Strategy.JwtVerifier.callsArgWith(
                3,
                null,
                test_data.valid_jwt.payload
            );
            ...
            chai.passport
                ...
                .req(function (req) {
                    req.headers["authorization"] =
                        "bearer " + test_data.valid_jwt.token;
                })
                .authenticate();
        });
        ...
        it("should call with the right issuer option", function () {
            ...
            expect(Strategy.JwtVerifier.args[0][2].issuer).to.equal(
                "TestIssuer"
            );
        });
        ...
        it("should call with the right audience option", function () {
            expect(Strategy.JwtVerifier.args[0][2]).to.be.an.object;
            expect(Strategy.JwtVerifier.args[0][2].audience).to.equal(
                "TestAudience"
            );
        });
        ...
        it("should call with the right ignoreExpiration option", function () {
            expect(Strategy.JwtVerifier.args[0][2]).to.be.an.object;
            expect(Strategy.JwtVerifier.args[0][2].ignoreExpiration).to.be
                .false;
        });
